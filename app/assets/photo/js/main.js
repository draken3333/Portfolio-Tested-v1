$(function () {
  ...
  const myModal = new HystModal({
    linkAttributeName: "data-hystmodal",
    // linkAttributeName: "data-newmodal",
...
$(function () {
  ...
  $(".header-slider").slick({
    ...
    arrows: false,
    fade: true,
    asNavFor: ".num-slider__item",
  });
  $(".num-slider__item").slick({
    slidesToShow: 3,
    slidesToScroll: 1,
  ...
  $(".slider-comment").slick({
    prevArrow:
      '<button type="button" class="slick-prev"><img src="images/section-comment/arrow-prew.svg" alt=""></button>',
    nextArrow:
      '<button type="button" class="slick-next"><img src="images/section-comment/arrow-next.svg" alt=""></button>',
    infinite: true,
  });
...
// *на чистом js с отступом для навигации
